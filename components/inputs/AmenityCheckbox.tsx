  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        ...
        />
        <button onClick={handleAddAmenity} className="bg-rose-500 text-white px-4 py-2 rounded-lg">
          ADD
        </button>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mt-3 mb-4">
        {amenitiesList.map((amenity) => (
          <span
            key={amenity}
            className="flex items-center gap-2 bg-rose-500 text-white text-xs px-4 py-1 rounded-full"
          >
            {amenity}
